...
from kratos_simulation_tests.first_order_stokes_variable_viscosity_pspg_sd.MainKratos import run_simulation as kratos_run_simulation
from kratos_simulation_tests.first_order_stokes_variable_viscosity_pspg_sd.ground_truth import GroundTruthSolver

def run_evaluation():

    elements_num = 4096

    kratos_files_path = Path("kratos_simulation_tests/first_order_stokes_variable_viscosity_pspg_sd/kratos_files")
